...
export const activityService = {
  ...
  route(code: string, participantId: string, start: ApiPoint, destination: ApiPoint) {
    return request<{ group: ApiGroup }>(`/groups/${code}/route`, { method: 'PATCH', body: JSON.stringify({ participantId, start, destination }) });
  },
  ...
  history() { return request<{ rides: ActivitySummary[] }>('/history'); },

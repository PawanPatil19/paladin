...
const styles = StyleSheet.create({
  ...
  mapButton: { width: 46, height: 46, borderRadius: 23, backgroundColor: colors.paper, borderWidth: 1, borderColor: 'rgba(24,53,44,0.08)', alignItems: 'center', justifyContent: 'center' }, mapButtonActive: { backgroundColor: colors.ink },
  liveBadge: { minHeight: 40, backgroundColor: colors.ink, borderRadius: 20, paddingHorizontal: 13, flexDirection: 'row', alignItems: 'center', gap: 6 }, liveDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: colors.orange }, liveText: { color: colors.white, fontWeight: '900', fontSize: 10, letterSpacing: 1 },
  ...
  mapTools: { position: 'absolute', right: 16, top: Platform.OS === 'android' ? 128 : 112, gap: 10 }, mapTool: { minWidth: 62, backgroundColor: colors.paper, borderRadius: 18, paddingHorizontal: 10, paddingVertical: 9, alignItems: 'center', borderWidth: 1, borderColor: 'rgba(24,53,44,0.08)' }, mapToolActive: { backgroundColor: colors.lime }, mapToolText: { color: colors.ink, fontSize: 8, fontWeight: '800', marginTop: 3 },
  bottomPanel: { marginHorizontal: 10, marginBottom: Platform.OS === 'android' ? 10 : 6, padding: 12, gap: 10, borderRadius: 27, backgroundColor: 'rgba(247,243,234,0.97)', borderWidth: 1, borderColor: 'rgba(24,53,44,0.08)' },
  permissionCard: { backgroundColor: '#FCE5DE', borderRadius: 16, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 9 }, link: { color: colors.orange, fontSize: 12, fontWeight: '800' },
  routeStrip: { backgroundColor: colors.ink, borderRadius: 18, paddingHorizontal: 13, paddingVertical: 11, flexDirection: 'row', alignItems: 'center', gap: 10 }, routePoint: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8 }, startDot: { width: 11, height: 11, borderRadius: 6, backgroundColor: colors.white, borderWidth: 3, borderColor: colors.orange }, routeEyebrow: { color: colors.mint, fontSize: 7, fontWeight: '900', letterSpacing: 1.2 }, routeName: { color: colors.white, fontWeight: '800', fontSize: 11, marginTop: 2 },
  ...
  backdrop: { position: 'absolute', left: 0, right: 0, top: 0, bottom: 0, backgroundColor: 'rgba(24,53,44,0.35)' }, sheet: { position: 'absolute', left: 0, right: 0, bottom: 0, backgroundColor: colors.cream, padding: 24, paddingBottom: 30, borderTopLeftRadius: 28, borderTopRightRadius: 28 }, sheetHandle: { width: 42, height: 5, borderRadius: 3, backgroundColor: colors.line, alignSelf: 'center', marginBottom: 20 }, sheetTitle: { color: colors.ink, fontSize: 30, fontWeight: '900' }, sheetBody: { color: colors.soft, fontSize: 14, lineHeight: 20, marginTop: 8 }, cheerGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 9, marginTop: 20 }, cheer: { width: '48%', minHeight: 58, backgroundColor: colors.paper, borderWidth: 1, borderColor: colors.line, borderRadius: 16, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 8 }, cheerText: { flex: 1, color: colors.ink, fontSize: 12, fontWeight: '800' },
  confirmBackdrop: { flex: 1, padding: 24, justifyContent: 'center', backgroundColor: 'rgba(24,53,44,0.46)' }, confirmCard: { borderRadius: 26, backgroundColor: colors.cream, padding: 22 }, confirmIcon: { width: 52, height: 52, borderRadius: 18, backgroundColor: colors.lime, alignItems: 'center', justifyContent: 'center', marginBottom: 18 }, confirmTitle: { color: colors.ink, fontSize: 26, fontWeight: '900' }, confirmBody: { color: colors.soft, fontSize: 14, lineHeight: 21, marginTop: 9 }, confirmActions: { gap: 10, marginTop: 22 },
});
